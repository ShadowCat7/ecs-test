...
export const cardSystem = (
    ...
    return {
        ...
        process: (components: Component[], elapsedTime: number) => {
            ...
            if (!justPressed(getControl('click'))) return;
